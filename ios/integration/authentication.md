...
```emphasis
Keep in mind that the sample Web Service provided in the [Quick Start Guide](/docs/ios/quick-start) is for testing purposes only and **cannot** be used in production.
```
