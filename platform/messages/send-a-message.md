...
| **notification** | object | Optional parameter; see [Push Notifications](https://developer.layer.com/docs/platform/misc#notification-customization) docs for detailed options |
| **schedule** | object | Optional parameter; see [Delayed Messaging](#delayed-messaging) |
